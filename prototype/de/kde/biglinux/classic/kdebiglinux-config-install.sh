...
kdebiglinux_config_install_kde_launcher () {
	...
	echo "sed -i 's/^launchers=.*/launchers=applications:pcmanfm-qt.desktop,applications:brave-browser.desktop,applications:sakura.desktop,applications:bigcontrolcenter.desktop,applications:big-store.desktop,applications:org.gnome.Calculator.desktop/g' ${HOME}/.kdebiglinux/classic/plasma-org.kde.plasma.desktop-appletsrc"
	sed -i "s/^launchers=.*/launchers=applications:pcmanfm-qt.desktop,applications:brave-browser.desktop,applications:sakura.desktop,applications:bigcontrolcenter.desktop,applications:big-store.desktop,applications:org.gnome.Calculator.desktop/g" "${HOME}/.kdebiglinux/classic/plasma-org.kde.plasma.desktop-appletsrc"
